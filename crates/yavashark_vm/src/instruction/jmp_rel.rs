...
pub fn jmp_if_strict_eq_rel(left: impl Data, right: impl Data, addr: JmpOffset, vm: &mut impl VM) -> Res {
    let left = left.get(vm)?;
    let right = right.get(vm)?;
...
pub fn jmp_if_strict_ne_rel(left: impl Data, right: impl Data, addr: JmpOffset, vm: &mut impl VM) -> Res {
    let left = left.get(vm)?;
    let right = right.get(vm)?;
...
pub fn jmp_if_lt_eq_rel(left: impl Data, right: impl Data, addr: JmpOffset, vm: &mut impl VM) -> Res {
    let left = left.get(vm)?;
    let right = right.get(vm)?;
...
pub fn jmp_if_gt_eq_rel(left: impl Data, right: impl Data, addr: JmpOffset, vm: &mut impl VM) -> Res {
    let left = left.get(vm)?;
    let right = right.get(vm)?;
