...
pub fn instance_of(lhs: VarName, rhs: VarName, vm: &mut impl VM) -> Res {
...
pub fn instance_of_acc(reg: Reg, vm: &mut impl VM) -> Res {
...
pub fn instance_of_reg(rhs: Reg, lhs: Reg, vm: &mut impl VM) -> Res {
