...
pub fn bitwise_or(lhs: VarName, rhs: VarName, vm: &mut impl VM) -> Res {
...
pub fn bitwise_or_acc(reg: Reg, vm: &mut impl VM) -> Res {
...
pub fn bitwise_or_reg(rhs: Reg, lhs: Reg, vm: &mut impl VM) -> Res {
