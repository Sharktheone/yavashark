...
pub fn lshift(lhs: VarName, rhs: VarName, vm: &mut impl VM) -> Res {
...
pub fn lshift_acc(reg: Reg, vm: &mut impl VM) -> Res {
...
pub fn lshift_reg(rhs: Reg, lhs: Reg, vm: &mut impl VM) -> Res {
