...
pub fn zero_fill_rshift(lhs: VarName, rhs: VarName, vm: &mut VM) -> Res {
...
pub fn zero_fill_rshift_acc(reg: Reg, vm: &mut VM) -> Res {
...
pub fn zero_fill_rshift_reg(rhs: Reg, lhs: Reg, vm: &mut VM) -> Res {
