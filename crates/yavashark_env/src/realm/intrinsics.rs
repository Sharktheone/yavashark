...
pub struct Intrinsics {
    ...
    pub string_iter: PartialIntrinsic<crate::builtins::StringIterator>,
    ...
    pub regexp_string_iter: PartialIntrinsic<crate::builtins::RegExpStringIterator>,
...
impl Intrinsics {
    pub fn new() -> Self {
        let obj = Prototype::new().into_object();
        let func = FunctionPrototype::with_proto(obj.clone()).into_object();

        Self {
            obj,
            func,
            array: Partial::default(),
            array_iter: Partial::default(),
            string_iter: Partial::default(),
            ...
            regexp_string_iter: Partial::default(),
            ty_error: Partial::default(),
            range_error: Partial::default(),
            reference_error: Partial::default(),
            syn_error: Partial::default(),
            eval_error: Partial::default(),
            uri_error: Partial::default(),
            aggregate_error: Partial::default(),
            suppressed_error: Partial::default(),
            eval: None,
            arraybuffer: Partial::default(),
            sharedarraybuffer: Partial::default(),
            data_view: Partial::default(),
            typed_array: Partial::default(),
            int8array: Partial::default(),
            uint8array: Partial::default(),
            uint8clampedarray: Partial::default(),
            int16array: Partial::default(),
            uint16array: Partial::default(),
            int32array: Partial::default(),
            uint32array: Partial::default(),
            float16array: Partial::default(),
            float32array: Partial::default(),
            float64array: Partial::default(),
            bigint64array: Partial::default(),
            biguint64array: Partial::default(),
            ...
            iterator_prototype: Partial::default(),
            iterator_helper: Partial::default(),
...
impl Default for Intrinsics {
    fn default() -> Self {
        Self {
            ...
            regexp_string_iter: Default::default(),
