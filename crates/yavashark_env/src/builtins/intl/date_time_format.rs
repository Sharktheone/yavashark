...
impl DateTimeFormat {
    #[call_constructor]
    fn construct(_locales: Option<String>, _options: Option<ObjectHandle>, realm: &mut Realm) -> ObjectHandle {
        Self::new(realm).into_object()
    }

    #[prop("supportedLocalesOf")]
    fn supported_locales_of(_locales: Option<String>, _options: Option<ObjectHandle>, realm: &Realm) -> ObjectHandle {
