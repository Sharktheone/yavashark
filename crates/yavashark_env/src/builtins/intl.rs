...
pub fn get_intl(
    ...
    obj.define_property_attributes("DateTimeFormat".into(), constr(&date_time_format, realm), realm)?;
    ...
    obj.define_property_attributes("DurationFormat".into(), constr(&duration_format, realm), realm)?;
    ...
    obj.define_property_attributes("RelativeTimeFormat".into(), constr(&relative_time_format, realm), realm)?;
